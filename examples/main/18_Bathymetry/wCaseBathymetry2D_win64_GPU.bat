...
%measuretool% -dirin %diroutdata% -pointsdef:ptels[x=2:1:80,y=32:0:32,z=-10:0.05:0] -onlytype:-all,+fluid -savevtk %dirout2%/WaterBottom -height -vars:-all -files:0 -hvars:-all,bottom
if not "%ERRORLEVEL%" == "0" goto fail
%measuretool% -dirin %diroutdata% -pointsdef:ptels[x=2:1:80,y=32:0:32,z=-10:0.05:1.5] -onlytype:-all,+fluid -savevtk %dirout2%/WaterSurface -height -vars:-all -hvars:depthsum
if not "%ERRORLEVEL%" == "0" goto fail
