...
export dirbinflexstruc="${dirbin}/FlexStruc"
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${dirbin}
export gencase="${dirbin}/GenCase_linux64"
export dualsphysicscpu="${dirbinflexstruc}/DualSPHysics5.2_FlexStrucCPU_linux64"
export dualsphysicsgpu="${dirbinflexstruc}/DualSPHysics5.2_FlexStruc_linux64"
...
${partvtk} -dirin ${diroutdata} -savevtk ${dirout2}/PartClamp -onlymk:10 -files:0
if [ $? -ne 0 ] ; then fail; fi

${partvtk} -dirin ${diroutdata} -savevtk ${dirout2}/PartStructure -onlymk:11
if [ $? -ne 0 ] ; then fail; fi
