...
set dirbinflexstruc="%dirbin%\FlexStruc"
set gencase="%dirbin%\GenCase_win64.exe"
set dualsphysicscpu="%dirbinflexstruc%\DualSPHysics5.2_FlexStrucCPU_win64.exe"
set dualsphysicsgpu="%dirbinflexstruc%\DualSPHysics5.2_FlexStruc_win64.exe"
